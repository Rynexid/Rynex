...
function getPostLoginUrl(user: { role?: string } | null): string {
  if (user?.role && STAFF_ROLES.includes(user.role)) {
    return "https://rynexdev-core.vercel.app";
  }
...
export default function LoginPage() {
  ...
  const handleCredentialsLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const redirectUrl = getPostLoginUrl(
        ...
        <div className="glass-card rounded-2xl border border-white/10 p-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              Akses portal dan kelola proyek Anda
            </p>
          </div>
