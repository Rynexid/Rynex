...
import { HeroBadge } from "../common/badge";
import { HeroCTA } from "../common/cta";
import { HeroCardStack } from "../desktop/heroCardStack";

export function DesktopHero() {
  return (
    <section className="relative flex min-h-[70vh] flex-col items-start overflow-x-hidden overflow-y-visible pt-32 pb-8">
